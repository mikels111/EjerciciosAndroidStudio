package com.example.aciertaminumero2;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cerca=findViewById(R.id.chkCerca);
        limite=findViewById(R.id.chkLimite);
        ...
        boton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(numero.length()>0){
                    ...
                    }else if(limite.isChecked() && cerca.isChecked()){
                        contador++;
                        if (contador < 10) {
                            if ((Integer.parseInt(numero.getText().toString())) > numeroAleatorio) {
                                Toast.makeText(getApplicationContext(), "El número es más pequeño", Toast.LENGTH_SHORT).show();
